...
> 않은 채 `corroborated`·`contested`·`inconclusive`를 기록합니다. opt-in M03·M06·A04
...
[ADR 0033](docs/adr/0033-registered-validation-control-materializers.ko.md)에 기록했습니다.
