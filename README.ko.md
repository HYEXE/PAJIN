...
> 않은 채 `corroborated`·`contested`·`inconclusive`를 기록합니다. 버전이 지정된
...
정확한 Claim identity·evidence·fallback·Blind 검토·confirmation 경계는
[ADR 0030](docs/adr/0030-candidate-aware-atomic-claim-validation.ko.md)과
[ADR 0031](docs/adr/0031-blind-evidence-review-boundary.ko.md)에 기록했습니다.
