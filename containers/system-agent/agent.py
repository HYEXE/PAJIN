...
def read_os_release() -> bytes:
    fd = os.open("/usr/lib/os-release", os.O_RDONLY | os.O_NOFOLLOW | os.O_NONBLOCK)
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        try:
            ...
            return
        result = {
            "schema": "pajin.sys-002.agent-read/v1",
