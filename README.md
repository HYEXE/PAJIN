...
| Primary gaps | Hypothesis/Observation Graph/replanning, broader HTTP/RAG/Admin discovery adapters and multi-wave Recon, multi-host/object-store Artifact transfer, non-KISA Local replay orchestration, portable/off-host replay proof, Finding/report review UI, distributed Workers, external integrations, and independently anchored production evidence |
