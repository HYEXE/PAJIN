...
| Capability registry | Immutable definition and exact Tool binding, complete seven-role code authority sets, inert deterministic authoring scaffolds, and an additive signed lifecycle registry with distinct publisher/reviewer roles, conservative maturity transitions, explicit deprecation, historical inspection, and profile-gated current-head activation. Durable storage and runtime dispatch wiring remain follow-up work. |
