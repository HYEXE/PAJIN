...
source/batch admission, 역할 기반 상태 조회 API와 자동 fresh-identity retry 발행도 구현됐다. Multi-item
versioned projection publication과 negative Control Plane retest가 남아 있어 M6-07B 전체는 미완료다.
