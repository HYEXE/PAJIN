...
> [`ADR-0044`](adr/0044-target-signed-tls-session-binding.ko.md)를 참조한다.
...
[ADR 0036](adr/0036-claim-bound-replay-execution-authority.ko.md),
[ADR 0044](adr/0044-target-signed-tls-session-binding.ko.md)를 따른다.
