...
> Claim을 append-only 원장과 v3 public projection까지 보존한다. Portable/off-host proof는
> 후속이므로 M6-07B 전체는 아직 미완료다.
...
- M6-07A의 명시적 Local KISA coordinator는 exact M03·M06·A04 allowlist와 한 프로세스·한
  ...
  negative Control Plane retest와 schema-v13 exact Claim별 공개 projection은 구현됐다.
  Portable/off-host proof는 남아 있다.
...
[ADR 0029](adr/0029-control-plane-replay-orchestration.ko.md),
