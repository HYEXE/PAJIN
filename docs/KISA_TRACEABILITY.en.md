...
> verification before and after transfer to a Control Plane on another host. A target issuer and
> large object-store/multipart Artifact transfer remain follow-up work, so M6-07B is not complete.
