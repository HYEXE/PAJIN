> 언어: [English](GRAPH-001-minimum-canonical-graph-model.en.md) | [한국어](GRAPH-001-minimum-canonical-graph-model.md)
...
[GRAPH-005](GRAPH-005-durable-sqlite-graph-store.ko.md)는 별도 single-Campaign SQLite Graph
