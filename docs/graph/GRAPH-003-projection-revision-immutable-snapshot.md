...
[GRAPH-004](GRAPH-004-consistency-recovery-stale-decision.md)는 concurrent
...
이 계약과 host-local CAS·reopen recovery를 적용했다. multi-host leadership과 atomic
ActionPermit 발급·dispatch는 남아 있다.
