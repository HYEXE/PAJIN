...
[GRAPH-004](GRAPH-004-consistency-recovery-stale-decision.md) now exercises concurrent
...
[GRAPH-005](GRAPH-005-durable-sqlite-graph-store.md) persists these contracts in a separate
