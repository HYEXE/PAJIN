...
- actual provider-backed off-host backup transport/scheduling, independent-host restore drills,
  managed key service integration, authoritative object-lock evidence, and independently
