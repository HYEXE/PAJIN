...
- 확장: [ADR 0029](0029-control-plane-replay-orchestration.ko.md),
  [ADR 0035](0035-claim-replay-public-state-projection.ko.md),
  [ADR 0036](0036-claim-bound-replay-execution-authority.ko.md)
...
- 이 후속 범위의 Control Plane receipt 공개키 서명, key rotation·revocation, verifier bundle과
  외부 trust anchor는 [ADR 0038](0038-portable-claim-receipt-attestation.ko.md)에서 구현됐다.
