...
- Control Plane Claim별 public projection은
  [ADR 0037](0037-control-plane-claim-specific-public-projection.ko.md)에서 구현됐다.
  [ADR 0038](0038-portable-claim-receipt-attestation.ko.md)은 Control Plane receipt 권위를 외부
