...
- Status: Accepted
- Date: 2026-07-17
- Implementation update: 2026-07-19 (전용 exact-KISA executor와 schema-v9 서버 finalization)
...
Host-facing API/database bridge는 published loopback port를 유지하기 위한 일반 Docker bridge다.
