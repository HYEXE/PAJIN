...
- [ADR 0011](0011-durable-control-plane.md) is extended with PostgreSQL
...
- [ADR 0012](0012-lease-aware-worker-daemon.md) authenticated leases, trusted executor registry,
...
- [ADR 0024](0024-cooperative-execution-cancellation.md) first-write-wins cancellation and the
...
- [ADR 0027](0027-independent-reproduction-confirmation-boundary.md) Candidate/Compiler/
...
- [ADR 0028](0028-durable-local-replay-ticket-ledger.md) canonical compilation binding,
