...
- Status: Accepted
- Date: 2026-07-14
- Extended by: [ADR 0024](0024-cooperative-execution-cancellation.en.md)
...
- [ADR 0022: Same-origin Control Plane Web Console](0022-same-origin-control-plane-web-console.en.md)
