> 언어: [English](0049-durable-single-campaign-sqlite-graph-store.en.md) | [한국어](0049-durable-single-campaign-sqlite-graph-store.ko.md)
...
[GRAPH-005](../graph/GRAPH-005-durable-sqlite-graph-store.ko.md)에 schema, recovery,
filesystem, conformance, 호환성, 남은 경계를 기록한다. 후속
[GRAPH-006](../graph/GRAPH-006-atomic-action-permit-authority.ko.md)은 exact v1 fingerprint를
...
- [ADR-0048: Minimum Graph와 Admission 일관성](0048-minimum-graph-and-admission-consistency.ko.md)
- [GRAPH-004: Consistency·Recovery·Stale Decision](../graph/GRAPH-004-consistency-recovery-stale-decision.ko.md)
- [ADR-0050: Consumed ActionPermit Dispatch Claim](0050-consumed-action-permit-dispatch-claim.ko.md)
