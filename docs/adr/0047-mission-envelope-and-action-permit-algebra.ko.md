> 언어: [English](0047-mission-envelope-and-action-permit-algebra.en.md) | [한국어](0047-mission-envelope-and-action-permit-algebra.md)
...
[GRAPH-006](../graph/GRAPH-006-atomic-action-permit-authority.ko.md)과
[ADR-0050](0050-consumed-action-permit-dispatch-claim.ko.md)은 canonical MissionEnvelope,
