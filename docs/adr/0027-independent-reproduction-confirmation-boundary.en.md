...
- [PAJIN Product Plan](../PAJIN_PRODUCT_PLAN.en.md)
- [ADR 0002: Tool Gateway and Worker isolation](0002-tool-gateway-and-worker-isolation.en.md)
- [ADR 0004: Dynamic multi-agent execution](0004-dynamic-multi-agent-execution.en.md)
- [ADR 0009: Provider-backed Agent Runtime](0009-provider-backed-agent-runtime.en.md)
- [ADR 0016: Tamper-evident Run integrity](0016-tamper-evident-run-integrity.en.md)
...
- [ADR 0028: Durable Local replay ticket ledger](0028-durable-local-replay-ticket-ledger.en.md)
