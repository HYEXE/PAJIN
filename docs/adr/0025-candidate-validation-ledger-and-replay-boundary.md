...
- [ADR 0004: Dynamic multi-agent execution and attenuated delegation](0004-dynamic-multi-agent-execution.md)
- [ADR 0009: Policy-bound Provider Runtime for reasoning roles](0009-provider-backed-agent-runtime.md)
- [ADR 0014: Conservative Bug Bounty finding deduplication](0014-conservative-bug-bounty-deduplication.md)
- [ADR 0016: Tamper-evident Run integrity chain](0016-tamper-evident-run-integrity.md)
- [ADR 0017: Local-only CTF Web Mode vertical slice](0017-local-ctf-web-mode.md)
- [ADR 0018: Bounded inline artifacts for CTF Crypto Mode](0018-bounded-ctf-crypto-artifacts.md)
- [ADR 0019: Bounded CTF Suite orchestration](0019-bounded-ctf-suite-orchestration.md)
- [ADR 0026: Trusted KISA candidate admission](0026-trusted-kisa-candidate-admission.md)
- [ADR 0027: Independent restricted reproduction as the confirmation boundary](0027-independent-reproduction-confirmation-boundary.md)
