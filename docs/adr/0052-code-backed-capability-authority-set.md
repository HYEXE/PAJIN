...
- Signed review/activation is implemented by CAP-004, and the first closed existing-Tool adapter
  bundle is implemented by CAP-005. Durable storage and ActionPermit runtime wiring remain
  follow-up work.
