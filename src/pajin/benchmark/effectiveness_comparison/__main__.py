"""Freeze private EFFECT-002 input, run the fixed local matrix, or verify a paired report."""
...
from pajin.benchmark.effectiveness_comparison.plan import ComparisonPlan, ComparisonSuite
from pajin.benchmark.effectiveness_comparison.runner import freeze_comparison, run_comparison
