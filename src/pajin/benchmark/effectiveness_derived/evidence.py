...
from pajin.benchmark.effectiveness_derived.plan import ComparisonPlan, comparison_pins
from pajin.benchmark.effectiveness_derived.scoring import (
    DetectorInput,
    PairedDetection,
    verify_pair,
)
