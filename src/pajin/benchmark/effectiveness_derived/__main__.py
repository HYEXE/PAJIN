"""Freeze private EFFECT-005 input, run the fixed local matrix, or verify a paired report."""
...
from pajin.benchmark.effectiveness_derived.plan import ComparisonPlan, ComparisonSuite
from pajin.benchmark.effectiveness_derived.runner import freeze_comparison, run_comparison
