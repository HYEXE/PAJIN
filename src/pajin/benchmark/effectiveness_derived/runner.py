...
from pajin.benchmark.effectiveness_derived.evidence import ComparisonIndex
...
from pajin.benchmark.effectiveness_precision.evidence import (
    ComparisonIndex as ComparisonIndexSource,
)
from pajin.benchmark.effectiveness_precision.plan import ComparisonPlan as PriorPlan
...
def consume_corpus(root: Path, plan: ComparisonPlan) -> None:
    ...
    marker = root / ".effect-005-consumed.sqlite3"
