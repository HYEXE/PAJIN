"""Freeze private EFFECT-004 input, run the fixed local matrix, or verify a paired report."""
...
from pajin.benchmark.effectiveness_precision.plan import ComparisonPlan, ComparisonSuite
from pajin.benchmark.effectiveness_precision.runner import freeze_comparison, run_comparison
