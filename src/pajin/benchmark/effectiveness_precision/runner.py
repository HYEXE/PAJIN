...
from pajin.benchmark.effectiveness_precision.evidence import ComparisonIndex
from pajin.benchmark.effectiveness_precision.plan import (
    ComparisonPlan,
    ComparisonSuite,
    comparison_pins,
)
from pajin.benchmark.effectiveness_precision.scoring import (
    DetectorInput,
    PairedDetection,
    measure_pair,
)
...
from pajin.benchmark.effectiveness_revision.plan import ComparisonPlan as PriorPlan
...
def consume_corpus(root: Path, plan: ComparisonPlan) -> None:
    ...
    marker = root / ".effect-004-consumed.sqlite3"
