"""Freeze private EFFECT-007 input, run the fixed local matrix, or verify a paired report."""
...
from pajin.benchmark.effectiveness_structured.plan import ComparisonPlan, ComparisonSuite
from pajin.benchmark.effectiveness_structured.runner import freeze_comparison, run_comparison
