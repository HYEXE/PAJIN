"""Freeze private EFFECT-006 input, run the fixed local matrix, or verify a paired report."""
...
from pajin.benchmark.effectiveness_transforms.plan import ComparisonPlan, ComparisonSuite
from pajin.benchmark.effectiveness_transforms.runner import freeze_comparison, run_comparison
