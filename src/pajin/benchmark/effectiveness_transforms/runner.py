...
from pajin.benchmark.effectiveness_derived.plan import ComparisonPlan as PriorPlan
from pajin.benchmark.effectiveness_transforms.evidence import ComparisonIndex
...
def consume_corpus(root: Path, plan: ComparisonPlan) -> None:
    ...
    marker = root / ".effect-006-consumed.sqlite3"
